...
__IDK?__ 1 pt: Constructor for `ResaleShop` class is present and sets attributes correctly
...
_YES__ 1 pt: Can successfully update the price/OS of a `Computer` contained in the inventory
...
___YES(?)__ 1 pt: Classes & class members all have header comments

__YES___ 1 pt: Clear and consistent indentation

__IDK___ 1 pt: Adheres to conventions on naming / capitalization
